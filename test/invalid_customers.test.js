describe('Save Customer Details Feature - Invalid Scenarios', () => {
         ...
         step ('2. Invalid SWIFT Code Length', (done) => {
        ...
        step ('3. Invalid SWIFT Code', (done) => {
       ...
       step ('4. Missing BSB Number', (done) => {
      ...
      step ('5. Invalid BSB Number', (done) => {
     ...
     step ('7. Invalid Country Code', (done) => {
